...
class UnoEnv(Env):
    ...
    def __init__(self, config):
        ...
        self.state_shape = [[416] for _ in range(self.num_players)]
    ...
    def _extract_state(self, state):
        ...
        last_8_actions = encode_action_sequence(self._process_action_seq()) # obs[8] - obs[13] 记录最近 6 步 actions
    ...
    def _process_action_seq(self, length=8):
